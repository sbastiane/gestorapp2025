        ...
        <footer className="footer">
            <div className="footer__top">
                <div className="footer__section footer__about">
                    ...
                    <p className="footer__text">
                        ...
                        luctus metus. Lorem ipsum dolor sit amet, consectetur eu vulputate
                        magna eros eu erat.
                    </p>
                </div>
            ...
            <div className="footer__bottom">
                <p className="footer__copyright">
                    © 2025 Copyright by <span className="footer__brand">JSAH</span>. All rights reserved.
                </p>
                <nav className="footer__nav">
                    <Link to={'/home'} className="footer__link">Home</Link>
                    <Link to={'/dashboard'} className="footer__link">Dashboard</Link>
                    <Link to={'/booking'} className="footer__link">Booking</Link>
                </nav>
            </div>
        </footer>
    );
